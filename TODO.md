...
- **Redact sensitive parameters in PHP stack traces**
  Use the `#[SensitiveParameter]` attribute for parameters like `RECAPTCHA_SECRET_KEY`, `SMTP_USERNAME`, `SMTP_PASSWORD`, `SMTP_CONTACT_RECIPIENT`.
